...
export const SERVICES: Record<ServiceSlug, ServiceInfo> = {
  ...
  soweto: {
    ...
    image: "/images/fleet/bmw-320d-2.jpg",
    imageAlt: "Intercoutra vehicle used for Johannesburg and Soweto tours",
  ...
  "cape-town": {
    ...
    image: "/images/fleet/bmw-msport-1.jpg",
    imageAlt: "Intercoutra vehicle used for Cape Town tours",
